...
lang DeclUseTypeCheck = TypeCheck + UseDeclAst
  sem typeCheckDecl env =
  | decl & DeclUse _ -> (env, decl)
end

lang DeclSemTypeCheck = SemDeclAst + ResolveType +
...
lang DeclLangTypeCheck = LangDeclAst + SemDeclAst + SynDeclAst +
                         TypeCheck + TypeDeclAst + DeclSemTypeCheck
  sem typeCheckDecl env =
  -- | DeclLang d ->
...
lang DeclSynTypeCheck = TypeCheck + SynDeclAst + ResolveType
  sem typeCheckDecl env =
  -- | DeclSyn d ->
...
lang ProgramTypeCheck = TypeCheck + MLangTopLevel
...
lang MLangTypeCheck = ProgramTypeCheck + MExprTypeCheck + MLangPrettyPrint +
                      DeclSynTypeCheck + DeclUseTypeCheck +
                      DeclLangTypeCheck
