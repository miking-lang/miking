...
lang MExprCmpTypeIndex = MExprAst
  ...
  | CMapInsert _ -> 86
  | CMapRemove _ -> 87
  | CMapFindWithExn _ -> 88
  | CMapFindOrElse _ -> 89
  | CMapFindApplyOrElse _ -> 90
  | CMapBindings _ -> 91
  | CMapSize _ -> 92
  | CMapMem _ -> 93
  | CMapAny _ -> 94
  | CMapMap _ -> 95
  | CMapMapWithKey _ -> 96
  | CMapFoldWithKey _ -> 97
  | CMapEq _ -> 98
  | CMapCmp _ -> 99
  | CMapGetCmpFun _ -> 100
  | CTensorCreateInt _ -> 101
  | CTensorCreateFloat _ -> 102
  | CTensorCreate _ -> 103
  | CTensorGetExn _ -> 104
  | CTensorSetExn _ -> 105
  | CTensorRank _ -> 106
  | CTensorShape _ -> 107
  | CTensorReshapeExn _ -> 108
  | CTensorCopyExn _ -> 109
  | CTensorSliceExn _ -> 110
  | CTensorSubExn _ -> 111
  | CTensorIterSlice _ -> 112
  | CBootParserParseMExprString _ -> 113
  | CBootParserParseMCoreFile _ -> 114
  | CBootParserGetId _ -> 115
  | CBootParserGetTerm _ -> 116
  | CBootParserGetType _ -> 117
  | CBootParserGetString _ -> 118
  | CBootParserGetInt _ -> 119
  | CBootParserGetFloat _ -> 120
  | CBootParserGetListLength _ -> 121
  | CBootParserGetConst _ -> 122
  | CBootParserGetPat _ -> 123
  | CBootParserGetInfo _ -> 124
