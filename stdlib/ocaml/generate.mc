...
-- Threads
utest ocamlEvalInt (generateEmptyEnv (bindall_
  [ ulet_ "v" (int_ 43)
...
utest ocamlEvalBool (generateEmptyEnv (bindall_
...
-- utest testCriticalSection with generateEmptyEnv testCriticalSection
