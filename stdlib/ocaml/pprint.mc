...
lang OCamlPrettyPrint =
  ...
  | CEmpty _ -> intrinsicOpSeq "empty"
  | CInsert _ -> intrinsicOpSeq "cons"
  | CFold _ -> intrinsicOpSeq "Helpers.fold_right"
  ...
  | CBootParserGetPropTy _ -> intrinsicOpBootparser "getPropTy"
