...
let optionMapOr: b -> (a -> b) -> Option a -> b = lam d. lam f. lam o.
...
let optionIsNone: Option a -> Bool = lam o. not (optionIsSome o)
...
-- the first option.
let optionAnd: Option a -> Option a -> Option a = lam o1. lam o2.
...
let optionXor: Option a -> Option a -> Option a = lam o1. lam o2.
